...
namespace aria
{
	...
	*	Le text modifié.
	*/
	Aria_API std::string replace( std::string const & text
	...
	*	Le text modifié.
	*/
	Aria_API std::string trimLeft( std::string const & text );
	/**
	*\brief
	...
	*	Le text modifié.
	*/
	Aria_API std::string trimRight( std::string const & text );
	/**
	*\brief
	...
	*	Le text modifié.
	*/
	Aria_API std::string lowerCase( std::string const & text );
	/**
	*\brief
	...
	*	Le text modifié.
	*/
	Aria_API std::string upperCase( std::string const & text );
	/**
	*\brief
	...
	*/
	Aria_API StringArray split( std::string const & str
